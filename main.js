...
// let Front-end Developer = document.querySelector('select')
// let Back-end Developer = document.querySelector('select')
// let Android Developer = document.querySelector('select')
// let Scrum Master = document.querySelector('select')
// let Lead Client Team = document.querySelector('select')
// let UI Designer = document.querySelector('select')
// let Commercial Director = document.querySelector('select')
// let Technical Support Lead = document.querySelector('')
// let Technical Support Specialist = document.querySelector('select')
// let Innovation Strategist = document.querySelector('select')
// let Data Engineer = document.querySelector('select')
// let Office Angel 010 = document.querySelector('select')
// let iOS Developer = document.querySelector('select')
// let Account & Technology Director = document.querySelector('select')
// let Cloud Engineer = document.querySelector('select')
// let UX Lead = document.querySelector('select')
// let System Operations = document.querySelector('select')
// let Managing Director = document.querySelector('select')
// let UX/UI Designer = document.querySelector('select')
// let UX Designer = document.querySelector('select')
// let Tech Lead = document.querySelector('select')
// let Developer = document.querySelector('select')

// Front-end Developer.addEventListener('click', function() {

//     this.toggle(Front-end Developer)
// })

// Back-end Developer.addEventListener('click', function() {

//     this.toggle(Back-end Developer)
// })

// Android Developer.addEventListener('click', function() {

//     this.toggle(Android Developer)
// })

// Scrum Master.addEventListener('click', function() {

//     this.toggle(Scrum Master)
// })

// Lead Client Team.addEventListener('click', function() {

//     this.toggle(Lead Client Team)
// })

// UI Designer.addEventListener('click', function() {

//     this.toggle(UI Designer)
// })

// Commercial Director.addEventListener('click', function() {

//     this.toggle(Commercial Director)
// })

// Technical Support Lead.addEventListener('click', function() {

//     this.toggle(Technical Support Lead)
// })

// Technical Support Specialist.addEventListener('click', function() {

//     this.toggle(Technical Support Specialist)
// })

// Innovation Strategist.addEventListener('click', function() {

//     this.toggle(Innovation Strategist)
// })

// Data Engineer.addEventListener('click', function() {

//     this.toggle(Data Engineer)
// })

// Office Angel 010.addEventListener('click', function() {

//     this.toggle(Office Angel 010)
// })

// iOS Developer.addEventListener('click', function() {

//     this.toggle(iOS Developer)
// })

// Account & Technology Director.addEventListener('click', function() {

//     this.toggle(Account & Technology Director)
// })

// Cloud Engineer.addEventListener('click', function() {

//     this.toggle(Cloud Engineer)
// })

// UX Lead.addEventListener('click', function() {

//     this.toggle(UX Lead)
// })

// System Operations.addEventListener('click', function() {

//     this.toggle(System Operations)
// })

// Managing Director.addEventListener('click', function() {

//     this.toggle(Managing Director)
// })

// UX/UI Designer.addEventListener('click', function() {

//     this.toggle(UX/UI Designer)
// })

// UX Designer.addEventListener('click', function() {

//     this.toggle(UX Designer)
// })

// Tech Lead.addEventListener('click', function() {

//     this.toggle(Tech Lead)
// })

// Developer.addEventListener('click', function() {

//     this.toggle(Developer)
// })
